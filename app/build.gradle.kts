...
dependencies {
    ...
    implementation(platform("dev.chrisbanes.compose:compose-bom:2023.04.00-beta01"))
    ...
    androidTestImplementation(platform("dev.chrisbanes.compose:compose-bom:2023.04.00-beta01"))
